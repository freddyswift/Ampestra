    ...
    private var currentStep: MediaKeyPermissionStep {
        ...
        case .inputMonitoringNeeded:
            return MediaKeyPermissionStep(
                ...
                detail: "Ampestra needs Input Monitoring to detect the volume media keys. It does not record ordinary typing.",
        ...
        case .inputMonitoringDenied:
            return MediaKeyPermissionStep(
                ...
                detail: "Turn on Ampestra in Privacy & Security, then return here.",
        ...
        case .accessibilityNeeded:
            return MediaKeyPermissionStep(
                ...
                detail: "Accessibility lets Ampestra intercept only the volume keys it routes to your speaker, so Mac volume does not change too.",
        ...
        case .working:
            return MediaKeyPermissionStep(
                ...
                detail: "Ampestra only consumes a volume key when it is routed to your speaker.",
